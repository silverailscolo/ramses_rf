...
CODES_SCHEMA: dict[Code, dict[str, Any]] = {  # rf_unknown
    ...
    Code._2411: {  # fan_params, HVAC
        ...
        RQ: r"^(00|01|15|16|17|21)00[0-9A-F]{2}([0-9A-F]{2})*$",  # Flexible parameter blocks
        RP: r"^(00|01|15|16|17|21)00[0-9A-F]{6}[0-9A-F]{8}([0-9A-F]{8}){0,3}([0-9A-F]{2}){1,3}$",  # 0-3 params + 1-3 footer bytes
        W_: r"^(00|01|15|16|17|21)00[0-9A-F]{6}[0-9A-F]{8}([0-9A-F]{8}){0,3}([0-9A-F]{2}){1,3}$",  # Same as RP for consistency
    },
