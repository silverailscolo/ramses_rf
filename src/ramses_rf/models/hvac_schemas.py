...
_2411_PARAMS_SCHEMA: dict[str, FanParamInfo] = {
    ...
    "31": FanParamInfo(
        "Time to change filter (days)", 0, 1800, 30, "10", "days"
    ),
    "3D": FanParamInfo(
        "Away mode Supply fan rate (%)", 0.0, 0.4, 0.005, "0F", "%"
    ),
    "3E": FanParamInfo(
        "Away mode Exhaust fan rate (%)", 0.0, 0.4, 0.005, "0F", "%"
    ),
    "3F": FanParamInfo(
        "Low mode Supply fan rate (%)", 0.0, 0.75, 0.005, "0F", "%"
    ),
    "40": FanParamInfo(
        "Low mode Exhaust fan rate (%)", 0.0, 0.75, 0.005, "0F", "%"
    ),
    "41": FanParamInfo(
        "Medium mode Supply fan rate (%)", 0.0, 0.75, 0.005, "0F", "%"
    ),
    "42": FanParamInfo(
        "Medium mode Exhaust fan rate (%)", 0.0, 0.75, 0.005, "0F", "%"
    ),
    "43": FanParamInfo(
        "High mode Supply fan rate (%)", 0.0, 1.0, 0.005, "0F", "%"
    ),
    "44": FanParamInfo(
        "High mode Exhaust fan rate (%)", 0.0, 1.0, 0.005, "0F", "%"
    ),
    "4B": FanParamInfo(
        "Night mode timer (minutes)", 0, 180, 10, "00", "minutes"
    ),
    "4C": FanParamInfo(
        "Away mode timer (minutes)", 0, 180, 10, "00", "minutes"
    ),
    "4E": FanParamInfo(
        "High mode timer (minutes)", 0, 180, 10, "00", "minutes"
    ),
    "50": FanParamInfo(
        "Low mode timer (minutes)", 0, 180, 10, "00", "minutes"
    ),
    "52": FanParamInfo(
